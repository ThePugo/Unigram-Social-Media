        ...
        <p class="profileButton">
            <?php
                ...
                if ($x!=$a) {
                    ...
                    if ($lesigue==FALSE) {
                    ?>
                        <a href="follow.php?nombredeusuario1=<?php echo $a ?>&nombredeusuario2=<?php echo $x ?>" id="profileButton">Seguir</a>
                    <?php
                    }
                    else {
                    ?>
                        <a href="unfollow.php?nombredeusuario1=<?php echo $a ?>&nombredeusuario2=<?php echo $x ?>" id="profileButtonFollowing">Siguiendo</a>
                    <?php
                    }
                }
            ?>
